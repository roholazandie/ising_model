...
class IsingLattice:
    ...
    #     """Find the correlation length of the system
    #     """
    #


def run_no_video(epochs):

    for temperature in np.linspace(0.001, 3, 20):
        lattice = IsingLattice(temperature, initial_state='r', size=100)
